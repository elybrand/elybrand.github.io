...
[here]({{ "../assets/notebooks/gitta_experiment.ipynb" | absolute_url }}). I encourage you to play around with it yourself: change the decision boundary to something more complicated, fiddle with the number of subnetworks,
